...
/**
 * a Helper class to unload the complexities of generating a logger for a class
 * or setting up file logging. 
 * @see LoggingHelper#getLogger(java.lang.String) 
 * @see LoggingHelper#getDefaultLogger() 
 * @see LoggingHelper#getClassLoggerForMe() 
 * @see LoggingHelper#RunningInDebugMode() 
